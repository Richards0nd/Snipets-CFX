...
---@param b number
---@param a number
function DrawLine_2d(x1, y1, x2, y2, width, r, g, b, a)
end
...
---@param vehicle number
---@return number
function GetVehicleDashboardColour(vehicle)
end
...
---@param vehicle number
---@return number
function GetVehicleInteriorColour(vehicle)
end
...
function GetVehicleXenonLightsCustomColor(vehicle)
end
...
function GetWorldCoordFromScreenCoord(screenX, screenY)
end
...
---@param p14 any
---@param p15 any
function TaskPlayAnimAdvanced(ped, animDict, animName, posX, posY, posZ, rotX, rotY, rotZ, animEnterSpeed, animExitSpeed,
